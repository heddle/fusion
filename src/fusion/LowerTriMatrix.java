...
/**
 * This class implements a lower triangular matrix. if it is declared with
 * dimension N the legal values are row: 1..N-1, col 1..N-1
 * 
 * if N is 5, valid row indices are 1..4 and valid col indices are 0 to row -1
 * 
 * in general: ROW: 1..N-1 COL: 0..ROW-1
 * 
 * 
